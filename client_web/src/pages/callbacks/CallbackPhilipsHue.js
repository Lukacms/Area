...
import { Home } from '../';
import { useCallbackPhilipsHue } from '../../hooks';

function CallBackPhilipsHue() {
  const { navigate, success, loading } = useCallbackPhilipsHue();
  ...
  const showInfos = () => {
    return success ? (
      <div>
        <h1>Success !</h1>
        <span>
          You are connected to PhilipsHue's service. Go <a href='/home'>to the home page</a> to add new
      ...
      <div>
        <h1>Failure</h1>
        You weren't able to connect to PhilipsHue's service. Go{' '}
...
export default CallBackPhilipsHue;
