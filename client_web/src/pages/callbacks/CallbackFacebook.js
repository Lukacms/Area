...
import { Home } from '../';
import { useCallbackFacebook } from '../../hooks';

function CallBackFacebook() {
  const { navigate, success, loading } = useCallbackFacebook();
  ...
  const showInfos = () => {
    return success ? (
      <div>
        <h1>Success !</h1>
        <span>
          You are connected to Facebook's service. Go <a href='/home'>to the home page</a> to add
      ...
      <div>
        <h1>Failure</h1>
        You weren't able to connect to Facebook's service. Go{' '}
