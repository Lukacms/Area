...
import { Home } from '../';
import { useCallbackDeezer } from '../../hooks';

function CallBackDeezer() {
  const { navigate, success, loading } = useCallbackDeezer();
  ...
  const showInfos = () => {
    return success ? (
      <div>
        <h1>Success !</h1>
        <span>
          You are connected to Deezer's service. Go <a href='/home'>to the home page</a> to add new
      ...
      <div>
        <h1>Failure</h1>
        You weren't able to connect to Deezer's service. Go{' '}
