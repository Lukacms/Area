...
import { Home } from '../';
import { useCallbackYoutube } from '../../hooks';

function CallBackYoutube() {
  const { navigate, success, loading } = useCallbackYoutube();
  ...
  const showInfos = () => {
    return success ? (
      <div>
        <h1>Success !</h1>
        <span>
          You are connected to Youtube's service. Go <a href='/home'>to the home page</a> to add new
      ...
      <div>
        <h1>Failure</h1>
        You weren't able to connect to Youtube's service. Go{' '}
