...
import { Home } from '../';
import { useCallbackLinkedin } from '../../hooks';

function CallBackLinkedin() {
  const { navigate, success, loading } = useCallbackLinkedin();
  ...
  const showInfos = () => {
    return success ? (
      <div>
        <h1>Success !</h1>
        <span>
          You are connected to Linkedin's service. Go <a href='/home'>to the home page</a> to add
      ...
      <div>
        <h1>Failure</h1>
        You weren't able to connect to Linkedin's service. Go{' '}
