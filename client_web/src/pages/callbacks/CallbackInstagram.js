...
import { Home } from '../';
import { useCallbackInstagram } from '../../hooks';

function CallBackInstagram() {
  const { navigate, success, loading } = useCallbackInstagram();
  ...
  const showInfos = () => {
    return success ? (
      <div>
        <h1>Success !</h1>
        <span>
          You are connected to Instagram's service. Go <a href='/home'>to the home page</a> to add
      ...
      <div>
        <h1>Failure</h1>
        You weren't able to connect to Instagram's service. Go{' '}
...
export default CallBackInstagram;
