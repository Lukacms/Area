  ...
  return (
    <Home>
      <Dialog
        ...
        maximizable>
        <Button style={{marginLeft: -10}} label={item.name} icon='pi pi-chevron-left' text severity='info' onClick={() => navigate(-1)} />
        {item.userConnected ?
          <p>You are connected to this service.</p> : <p>You are not connected.</p>}
        {item.userConnected ? <Button label='Change account' text severity='info' size='small' /> : <Button label='Connect' text severity='info' size='small' />}
        <br/>
