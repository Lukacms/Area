  ...
  const items = [
    {
      ...
      items: [
        {
          label: 'action disc 1',
          command: (event) => {clickAct(items[0].items[0].label);}
        },
        {
          label: 'action disc 2',
          command: (event) => {clickAct(items[0].items[1].label);}
        },
      ],
    },
    {
      ...
      items: [
        {
          label: 'action mail1',
          command: (event) => {clickAct(items[1].items[0].label);}
        },
        {
          label: 'action mail2',
          command: (event) => {clickAct(items[1].items[1].label);}
        },
      ],
    },
  ];
      ...
      items: [
        {
          ...
          command: (event) => {clickReact(items2[0].items[0].label);}
        },
        {
          label: 'reaction disc 2',
          command: (event) => {clickReact(items2[0].items[1].label);}
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          command: (event) => {clickReact(items2[1].items[0].label);}
        },
        {
          label: 'reaction mail2',
          command: (event) => {clickReact(items2[1].items[1].label);}
        },
      ],
    },
  ];
  ...
  return (
    <div className='globalDiv'>
      <div className='leftDiv'>
        ...
        <Divider />
        <PanelMenu model={items3} className='pannelMenu' onDragEnd={e => {onDragEnd(e.target.dispatchEvent)}}/>
      </div>
